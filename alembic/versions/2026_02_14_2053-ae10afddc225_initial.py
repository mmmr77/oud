...
Revision ID: ae10afddc225
Revises: 
Create Date: 2026-02-14 20:53:03.699243
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['cat_id'], ['cat.id'], name=op.f('fk_poet_cat_id_cat')),
